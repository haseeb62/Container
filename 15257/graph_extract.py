...
def generateBinary(input_file, output_file, query_file, inputLog_path):
    ...
    with open(output_file, "w") as outfile:
        ...
        while count < flow_count:
            outfile.write("dot -Tsvg -o ~/15257/15257_" +
                          str(count) + ".svg 15257_" + str(count) + ".dot\n")
            with open("inputs" + str(count), "w") as inputs:
                inputs.write(
                    "load /home/vagrant/15257/" + query_file + str(count) + '\n')
                inputs.write("list\n")
                inputs.write("exit\n")
            count += 1
...
if __name__ == '__main__':
    ...
    generateBinary(extractedFile, "cve.sh", "SPADE-queries",
                   "/home/vagrant/15257/15257_audit.log")
